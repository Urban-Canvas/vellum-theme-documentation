...
<div class="support-layout">
  <section class="support-panel support-form-panel" aria-labelledby="support-form-title">
    ...
    <form class="support-form" action="https://formsubmit.co/murungi.mutugi@gmail.com" method="POST" enctype="multipart/form-data">
      ...
      <div class="support-field-row">
        ...
        <div class="support-field">
          <label for="store-url">Shopify store URL <span aria-hidden="true">*</span></label>
          <input id="store-url" name="store_url" type="url" placeholder="https://storename.myshopify.com" inputmode="url" required>
        </div>
      </div>

      <div class="support-field-row">
        <div class="support-field">
          <label for="issue-type">What do you need help with? <span aria-hidden="true">*</span></label>
          <select id="issue-type" name="issue_type" required>
            <option value="" selected disabled>Select a topic</option>
            <option>Theme setup</option>
            <option>Theme customization</option>
            <option>Unexpected theme behavior</option>
            <option>App compatibility</option>
        ...
        <div class="support-field">
          <label for="affected-url">Affected page URL</label>
          <input id="affected-url" name="affected_page_url" type="url" placeholder="https://storename.com/products/example" inputmode="url">
        </div>
      </div>
      ...
      <div class="support-field">
        <label for="attachment">Screenshot or diagnostic file <span aria-hidden="true">*</span></label>
        <input id="attachment" name="attachment" type="file" accept=".png,.jpg,.jpeg,.webp,.gif,.pdf,.txt,.log,.zip" required>
        <p class="support-help">PNG, JPG, WEBP, GIF, PDF, TXT, LOG, or ZIP. Maximum total upload size: 10 MB.</p>
      </div>

      <label class="support-consent" for="privacy-consent">
        <input id="privacy-consent" name="privacy_consent" type="checkbox" value="Accepted" required>
        <span>I understand that this submission is processed by FormSubmit and emailed to Urban Canvas support. I have not included passwords, payment details, customer exports, or API credentials. <span aria-hidden="true">*</span></span>
      </label>

      <button class="support-submit" type="submit">Send support request</button>
      <p class="support-fallback">If the form is unavailable, email <a href="mailto:murungi.mutugi@gmail.com">murungi.mutugi@gmail.com</a>.</p>
    </form>
  </section>
  ...
  <aside class="support-panel support-aside" aria-label="Support information">
    ...
    <div class="support-note">
      <strong>What Shopify handles</strong>
